...
if __name__ == "__main__":
    ...
    obj_Xs = [[-0.25, 0.1, -1.49e-01+0.2, 1.03e-04, 2.43e-04, 1.79e+00],
              [0.2, 4.10e-03, -1.49e-01+0.2, 1.03e-04, 2.43e-04, 1.79e+00]]
    move_obj_target_X = [-0.25, 4.10e-03, -1.49e-01+0.2, 1.03e-04, 2.43e-04, 1.79e+00]  # cup-cup: move first cup from x=-0.25 to x=-0.10, while the fixed cup is at x=0
    ...
    # move_obj_target_X = [0, -1.43946832e-02, -1.79232350e-01+0.19, -5.76184115e-05,  3.68892728e-05, -1.15680692e+00]  # toruslarge-toruslarge: move torus from x=-0.2 to x=0, while the other torus is at x=0.2
